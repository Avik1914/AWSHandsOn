...
public class App {
    ...
    private static final String S3_BUCKET = "new-bucket-avik-dragon-json";
    private static final String BUCKET_POLICY_PATH = "/home/ec2-user/environment/java_8/website_security_policy.json";
